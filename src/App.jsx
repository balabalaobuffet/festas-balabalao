...
const PKG_INFANTIL = [
  ...
  { id: "inf-formiguinha-1", name: "Formiguinha 1", cat: "infantil", subCat: "promocionais",
    desc: "Pacote essencial com 7 variedades de salgados, docinhos e bolo brigadeiro",
  ...
  { id: "inf-formiguinha-2", name: "Formiguinha 2", cat: "infantil", subCat: "promocionais",
    desc: "Mais variedade com 8 salgados, docinhos, bolo brigadeiro, lembrancinhas e meia hora extra de festa",
  ...
  { id: "inf-formiguinha-3", name: "Formiguinha 3", cat: "infantil", subCat: "promocionais",
    desc: "O promocional mais completo: 9 salgados, escolha de docinhos e bolo brigadeiro",
  ...
  { id: "inf-formigueiro-1", name: "Formigueiro 1", cat: "infantil", subCat: "tradicionais",
    desc: "11 salgados, docinhos, bolo com recheio à escolha, torta salgada e mesa de café",
    obs: "Seg a sex, finais de semana e feriados", dur: { h: 4, m: 0, tol: 30 },
    groups: [
      { id: "salgados", name: "Salgados", icon: "utensils", sections: [
  ...
  { id: "inf-formigueiro-2", name: "Formigueiro 2", cat: "infantil", subCat: "tradicionais",
    desc: "13 salgados, torta salgada ou massa, docinhos e bolo",
    obs: "Seg a sex, finais de semana e feriados", dur: { h: 4, m: 0, tol: 30 },
    groups: [
  ...
  { id: "inf-formigueiro-3", name: "Formigueiro 3", cat: "infantil", subCat: "tradicionais",
    desc: "O tradicional mais completo: 14 salgados, torta salgada e massa, docinhos, bolo, gelato Borelli e mesa de café",
    obs: "Seg a sex, finais de semana e feriados", dur: { h: 4, m: 0, tol: 30 },
    groups: [
  ...
  { id: "inf-bala-balao", name: "Festa Bala Balão", cat: "infantil", subCat: "premium",
    desc: "Experiência premium: entrada, prato principal, sobremesa empratada, docinhos, bolo, cerveja e gelato Borelli",
    obs: "Seg a sex, finais de semana e feriados", dur: { h: 4, m: 30, tol: 30 },
    groups: [
  ...
  { id: "inf-bala-balao-premier", name: "Bala Balão Premier", cat: "infantil", subCat: "premium",
    desc: "A experiência mais exclusiva: mesa de frios, menu com entrada, principal e sobremesa, docinhos, bolo, cerveja e espumante, gelato Borelli e doces personalizados",
    obs: "Seg a sex, finais de semana e feriados", dur: { h: 4, m: 30, tol: 30 },
    groups: [
...
const PKG_ADULTOS = [
  ...
  { id: "ad-celebra", name: "Celebra", cat: "adultos",
    desc: "11 variedades de salgados, docinhos, torta salgada, bolo e mesa de café",
    obs: "Seg a sex, finais de semana e feriados · Início até às 19h30", dur: { h: 4, m: 0, tol: 30 },
    groups: [
      { id: "salgados", name: "Salgados", icon: "utensils", sections: [
        { id: "s-fix", name: "6 salgados inclusos", type: "fixed", items: [...S6_F1] },
        { id: "s-choice", name: "Escolha mais 5 variedades", type: "choice", required: true,
  ...
  { id: "ad-exclusive", name: "Exclusive", cat: "adultos",
    desc: "14 variedades de salgados, torta salgada e massa, docinhos, bolo, gelato Borelli e mesa de café",
    obs: "Seg a sex, finais de semana e feriados · Início até às 19h30", dur: { h: 4, m: 0, tol: 30 },
    groups: [
      gSalgados(5, 3), gBebidas(), gPrato2(),
      gBolo([...RB, R_BOMB, R_TRUF, R_BM, R_DLM]),
  ...
  { id: "ad-premier", name: "Premier", cat: "adultos",
    desc: "A experiência completa: mesa de frios, menu clássico com entrada, principal e sobremesa, docinhos, bolo, cerveja e espumante, gelato Borelli e doces personalizados",
    obs: "Seg a sex, finais de semana e feriados · Início até às 19h30", dur: { h: 4, m: 30, tol: 30 },
    groups: [
      gSalgados(5, 3), gBebidas(CERVEJA, ESPUMANTE), gMesaFrios(), gMenu5(),
      gBolo([...RB, R_TRUF, R_ABAC, R_BM, R_DLM]),
...
const PKG_BODAS = [
  ...
  { id: "bo-bala-balao", name: "Bala Balão", cat: "bodas",
    desc: "Menu com entrada, principal e sobremesa empratada, docinhos, bolo, cerveja e gelato Borelli",
    obs: "Seg a sex, finais de semana e feriados · Início até às 19h30", dur: { h: 4, m: 30, tol: 30 },
    groups: [
      gSalgados(5, 3), gBebidas(CERVEJA), gMenu3(),
      gBolo([...RB, R_TRUF, R_ABAC, R_BM, R_DLM]),
...
const PKG_BATIZADOS = [
  ...
  { id: "bat-balabalao", name: "Batizado Bala Balão", cat: "batizados",
    desc: "Menu com entrada, principal e sobremesa, docinhos, bolo, cerveja e gelato Borelli",
    obs: "Seg a sex, finais de semana e feriados", dur: { h: 4, m: 30, tol: 30 },
    groups: [
      gSalgados(5, 3), gBebidas(CERVEJA), gMenu3(),
      gBolo([...RB, R_TRUF, R_ABAC, R_BM, R_DLM]),
  ...
  { id: "bat-premier", name: "Batizado Premier", cat: "batizados",
    desc: "Mesa de frios, menu clássico com entrada, principal e sobremesa, docinhos, bolo, cerveja e espumante, gelato Borelli e doces personalizados",
    obs: "Seg a sex, finais de semana e feriados", dur: { h: 4, m: 30, tol: 30 },
    groups: [
      gSalgados(5, 3), gBebidas(CERVEJA, ESPUMANTE), gMesaFrios(), gMenu5(),
      gBolo([...RB, R_TRUF, R_ABAC, R_BM, R_DLM]),
...
const PKG_WEDDING = [
  { id: "mw-bala-balao", name: "Recepção Bala Balão", cat: "wedding",
    desc: "Menu com entrada, principal e sobremesa empratada, docinhos, bolo, cerveja e gelato Borelli",
    obs: "Seg a sex, finais de semana e feriados · Início até às 20h", dur: { h: 4, m: 30, tol: 30 },
    groups: [
      gSalgados(5, 3), gBebidas(CERVEJA), gMenu3(),
      gBolo([...RB, R_TRUF, R_ABAC, R_BM, R_DLM]),
  ...
  { id: "mw-unique", name: "Recepção Unique", cat: "wedding",
    desc: "Experiência totalmente exclusiva: cardápio autoral, docinhos, bolo, mesa de guloseimas e decoração dos sonhos",
    obs: "Seg a sex, finais de semana e feriados · Início até às 20h · Até 85 convidados", dur: { h: 5, m: 0, tol: 30 },
    groups: [
...
const PKG_FORMATURAS = [
  { id: "fmt-1", name: "Formatura 1", cat: "formaturas",
    desc: "11 variedades de salgados, docinhos, bolo, torta salgada e mesa de café",
    obs: "Seg a sex, finais de semana e feriados", dur: { h: 4, m: 0, tol: 30 },
    groups: [
      { id: "salgados", name: "Salgados", icon: "utensils", sections: [
        { id: "s-fix", name: "6 salgados inclusos", type: "fixed", items: [...S6_F1] },
  ...
  { id: "fmt-2", name: "Formatura 2", cat: "formaturas",
    desc: "13 variedades de salgados, torta salgada ou massa, docinhos e bolo",
    obs: "Seg a sex, finais de semana e feriados", dur: { h: 4, m: 0, tol: 30 },
    groups: [
      gSalgados(5, 2), gBebidas(), gPrato1(),
      gBolo([...RB, R_BOMB, R_TRUF]),
  ...
  { id: "fmt-3", name: "Formatura 3", cat: "formaturas",
    desc: "O mais completo: 14 salgados, torta salgada e massa, docinhos, bolo, gelato Borelli e mesa de café",
    obs: "Seg a sex, finais de semana e feriados", dur: { h: 4, m: 0, tol: 30 },
    groups: [
      gSalgados(5, 3), gBebidas(), gPrato2(),
      gBolo([...RB, R_BOMB, R_TRUF, R_BM, R_DLM]),
